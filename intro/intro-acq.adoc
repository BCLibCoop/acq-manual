...
Before beginning to use Acquisitions, the Acquisitions initial setup must be completed by the Acquisitions administrator:. Refer to xref:_acquisitions_module_configuration[] for details.
