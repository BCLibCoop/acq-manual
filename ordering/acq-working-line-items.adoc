...
+
. The status of the line item becomes _Delayed_.  The colour changes to blue and the 
delayed count on the line item increases.
...
+
. The status of the line item becomes Canceled and the colour changes to white. The 
canceled count on the line item increases.
...
If you are ordering multiple copies of an item on the same line item you can cnacel
specific items as long as they have the status of on-order.
