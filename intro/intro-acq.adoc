...
[NOTE]
======
The Acquisitions module is an add-on service with additional costs. Please 
https://bc.libraries.coop/support/[contact Co-op Support] for information regarding adding this module.
======
