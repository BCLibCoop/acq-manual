...
+
. Click on the hyper linked name of the funding source you would like to apply credit to.
...
+
.. *Debits* - The Allocations tab tracks all allocations from the funding source to funds. After 
allocating to a fund you will need to click Reload to view the Allocations tab.
+
