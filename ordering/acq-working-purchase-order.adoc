...
. Click *Cancel Order*.
+
image::images/acquisitions/working-purchase-order/cancel-po-1.png[alt="purchase order screen highlighting state is Pending, name is delete1, and total line items is 0"]
+
. Select a reason from the drop down menu.
.. Choose a reason that begins with *Canceled*
. Click *Apply*.
+
image::images/acquisitions/working-purchase-order/cancel-po-2.png[alt="purchase order screen highlighting state is Pending, name is delete1, and total line items is 0"]
+
. The status of the purchase order becomes Canceled and all the line items 
colour changes to white.
+
image::images/acquisitions/working-purchase-order/cancel-po-3.png[alt="purchase order screen highlighting state is Pending, name is delete1, and total line items is 0"]
+
...
. Click *Cancel Order*.
+
image::images/acquisitions/working-purchase-order/delay-po-1.png[alt="purchase order screen highlighting state is Pending, name is delete1, and total line items is 0"]
+
. Select a Reason from the drop down menu.
.. Choose a reason that begins with *Delayed*
. Click *Apply*.
+
image::images/acquisitions/working-purchase-order/delay-po-2.png[alt="purchase order screen highlighting state is Pending, name is delete1, and total line items is 0"]
+
. The status of the purchase order becomes Delayed and all the line items colour changes to blue.
+
image::images/acquisitions/working-purchase-order/delay-po-3.png[alt="purchase order screen highlighting state is Pending, name is delete1, and total line items is 0"]
+
