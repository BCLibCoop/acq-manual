...
Modify the default purchase order search to generate a list of pending purchase orders.
...
. Click *Search*.
+
image::images/acquisitions/searchinvoice.png[]
+
. View your search results.

Modify the default invoice search to search for a specific invoice by "Vendor Invoice ID"

anchor:vendor-invoice[search by invoice ID]

.Search for invoice by vendor invoice ID
. Click *Acquisitions* -> *Open Invoices*.
. Choose *I-Vendor Invoice ID* from the drop down menu.
. Enter the invoice ID found on the paper invoice.
. Click *Search*.
+
image::images/acquisitions/searchinvoice2.png[]
+
. View your search results.
