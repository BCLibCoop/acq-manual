...
. xref:_lineitem_attribute_title[]
. xref:_lineitem_attribute_status[]
. xref:_order_identifier[]
. xref:_lineitem_attribute_price[]
. xref:_lineitem_attribute_actions[]
. xref:_lineitem_attribute_tracking[]
. xref:_lineitem_attribute_id[]
. xref:_existing_copies[]
. xref:_lineitem_attribute_copies[]
. xref:_lineitem_attribute_detail[]
. xref:_lineitem_attribute_notes[]
. xref:_link_catalogue[]
. xref:_worksheet[]
. xref:_lineitem_attribute_requests[]
. xref:_lineitem_attribute_invoice[]
. xref:_lineitem_attribute_provider[]
. xref:_lineitem_attribute_queue[]

anchor:_lineitem_attribute_title[Title & Publishing information]
...
anchor:_lineitem_status[Status]

*Line Item Status* - Refer to xref:_line_item_status[] for details.

anchor:_order_identifier[Order Identifier]
...
anchor:_lineitem_attribute_price[Estimated Price]
...
anchor:_lineitem_attribute_actions[Actions]
...
anchor:_lineitem_attribute_tracking[Line Item Tracking]
...
anchor:_lineitem_attribute_copies[Items]
...
anchor:_lineitem_attribute_notes[Notes and Alerts]

*Notes and Alerts* - Use the Notes link to add notes or alerts to a line item.


anchor:_link_catalogue[Link to Catalog]
...
anchor:_lineitem_attribute_requests[Requests]

*Patron Requests* - this feature is not currently used by Sitka libraries

anchor:_lineitem_attribute_invoice[Invoice]

*Invoice* - a link to the invoice

anchor:_lineitem_attribute_provider[Provider]

*Provider* - the name of the provider for the line item.

anchor:_lineitem_attribute_queue[Queue]
