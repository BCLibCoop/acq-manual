...
+
image::images/acquisitions/originatingacq.png[Show Originating Acquisitions from Item Status]

.Show Originating Acquisitions from the Catalogue
. Click *view*
+
image::images/acquisitions/originatingacq2.png[Show Originating Acquisitions from the Catalogue]
+
. Click *Actions* -> Show *Originating Acquisition*
+
image::images/acquisitions/originatingacq3.png[Show Originating Acquisitions from the Catalogue]
