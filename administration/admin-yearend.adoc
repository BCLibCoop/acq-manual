...
. Ensure that the Library Setting _Allow funds to be rolled over without bringing the money along_ is set to *True*.
...
. Ensure that the Library Setting _Allow funds to be rolled over without bringing the money along_ is set to *False* .
