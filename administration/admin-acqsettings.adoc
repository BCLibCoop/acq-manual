...
upload | True/False | Sitka | Not used as libraries should always double check their
purchase orders before activating.
...
Text | Sitka | Not used as libraries should be required to set the provider or
select the approriate template to ensure the purchase order is created for the 
correct provider.
